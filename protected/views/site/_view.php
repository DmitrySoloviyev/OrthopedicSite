<tr>
    ...
    <td><?php echo 'л ';
        echo CHtml::encode($data->sizeLEFT->SizeValue) . "<br />";
        echo 'п ';
        echo CHtml::encode($data->sizeRIGHT->SizeValue); ?>
    </td>
    <td><?php echo 'л ';
        echo CHtml::encode($data->urkLEFT->UrkValue) . "<br />";
        echo 'п ';
        echo CHtml::encode($data->urkRIGHT->UrkValue); ?>
    </td>
    <td><?php echo CHtml::encode($data->material->MaterialValue); ?></td>
    <td><?php echo 'л ';
        echo CHtml::encode($data->heightLEFT->HeightValue) . "<br />";
        echo 'п ';
        echo CHtml::encode($data->heightRIGHT->HeightValue); ?>
    </td>
    <td><?php echo 'л ';
        echo CHtml::encode($data->topVolumeLEFT->TopVolumeValue) . "<br />";
        echo 'п ';
        echo CHtml::encode($data->topVolumeRIGHT->TopVolumeValue); ?>
    </td>
    <td><?php echo 'л ';
        echo CHtml::encode($data->ankleVolumeLEFT->AnkleVolumeValue) . "<br />";
        echo 'п ';
        echo CHtml::encode($data->ankleVolumeRIGHT->AnkleVolumeValue); ?>
    </td>
    <td><?php echo 'л ';
        echo CHtml::encode($data->kvVolumeLEFT->KvVolumeValue) . "<br />";
        echo 'п ';
        echo CHtml::encode($data->kvVolumeRIGHT->KvVolumeValue); ?>
    </td>
