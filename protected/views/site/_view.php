<tr>
	...
	<td><?php echo CHtml::encode($data->customer->CustomerSN)." "
						.iconv_substr(CHtml::encode($data->customer->CustomerFN), 0, 1, 'utf8').". "
						.iconv_substr(CHtml::encode($data->customer->CustomerP), 0, 1, 'utf8')."."
		;?></td>
	<td><?php echo CHtml::encode($data->employee->EmployeeSN)." "
						.iconv_substr(CHtml::encode($data->employee->EmployeeFN), 0, 1, 'utf8').". "
						.iconv_substr(CHtml::encode($data->employee->EmployeeP), 0, 1, 'utf8')."."
		?></td>
