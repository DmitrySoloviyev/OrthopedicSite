...
<tr>
    ...
    <td style="color:grey;padding-bottom: 3%;">
        ...
        Это так же позволило сделать комментарии к заказам и моделям и поле описание у моделей полнотекстовыми и больше
        не ограниченными по длине.
...
<tr>
    ...
    (admin, имеющий право заводить новых пользователей). Редактировать и удалять можно только свои заказы и модели.
    Администратору, как и положено - любые. Кроме того, администратор имеет возможность назначать роли пользователям.
    Кэширование сессии пользователя. Покрытие приложения логами.
    <p class="release_date">(xx.xx.2015)</p>
    </td>
</tr>
-->
