...
<div style="line-height:1.6; text-align: justify;">
    ...
    <div class="row-fluid">
        ...
        <div class="span11" style="padding-bottom: 1%;">
            ...
            <a href="http://www.highcharts.com/">highcharts</a>, удален jqplot. В раздел статистики добавлены 3
            графика, аналогичные существующим, но по моделям.
            Кэширование сессии пользователя. Покрытие приложения логами. Все логи отображаются в админке.
