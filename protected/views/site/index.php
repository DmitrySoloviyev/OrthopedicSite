...
<ul>
    ...
    <li>Переделать окно с регистрацией и просмотром модельеров на главной странице</li>
    <li>Предпросмотр загружаемого изображения модели</li>
    <li>Включить кэширование схем бд для улучшения производительности</li>
...
<!--    <tr>
        ...
        <td style="color:grey;padding-bottom: 1%;">
            Развертывание приложения происходит при помощи менеджера зависимостей для PHP -
            <a href="https://getcomposer.org/">Composer</a>. Поиск осуществляется при помощи поисковой системы
...
<!--    <tr>
        ...
        <td style="color:grey;padding-bottom: 1%;">Новый виток развития. Каких-либо визуальных изменений практически нет, все изменения и
            доработки "под капотом" сайта. Текущая ветка имеет чисто технический характер. В первую очередь уделено
            внимание безопасности сайта, его стабильности и оптимизации, с целью повышения производительности.
            Внедрено кэширования данных, реализовано при помощи <a href="http://redis.io/"><i>Redis</i></a>.
            Проанализированы и оптимизированы все MySQL-запросы, добавлены недостающие индексы к таблицам. Немного
            переработана структура БД, а ее создание вынесено в миграцию, что позволит в будущем производить
            безболезненные изменения в ее структуре, если это потребуется. Включено кэширование схем БД для улучшения
            производительности. Более тесная и полная интеграция с фреймворком Yii. Подключены php-акселлераторы.
            Полная переработка, оптимизация и профессиональное оформление кода. Блочная верстка страниц. Новое окно с
            регистрацией и просмотром модельеров на главной странице, корректировка стилей.
        </td>
    </tr>-->
    ...
    <tr>
        ...
        <td>Добавлена возможность сохранять заказы
            в Excel за выбранный промежуток времени (реализована с помощью <a href="http://phpexcel.codeplex.com/"><i>PHPExcel</i></a>)
            и графический раздел статистики (реальзован с помощью <a href="http://www.jqplot.com/"><i>jqPlot</i></a>).
    ...
    <tr class="infoMessage">
        ...
        <td style="padding: 1% 0;"><b> Состоялся <u>релиз</u> приложения для Android по работе с базой данных -
            <a href="<?php echo Yii::app()->request->baseUrl; ?>/assets/OrthopedicDB.apk">OrthopedicDB</a>(текущая
            версия 1.0).<b></td>
    </tr>
    ...
    <tr>
        ...
        <td>Вновь проведена серьезная переработка сайта - сайт переписан под
            <a href="http://www.yiiframework.com/"><i>Yii</i></a>, что делает его модульным и легко расширяемым.
    ...
    <tr class="infoMessage">
        <td style="vertical-align:text-top; padding: 1% 0;"><i><b>Сообщение:</b></i></td>
        <td style="padding: 1% 0;"><b>
                Доступна бета-версия приложения для Android по работе с базой данных - <a href="">OrthopedicDB</a>
                (текущая версия 0.9.1).<b></td>
    </tr>
    ...
    <tr>
        ...
        <td> Проверка заполнения форм до отправки. Исправлено автозаполнение
            ...
            применением библиотеки <a href="http://jquery.com/"><i>jQuery</i></a>!
        </td>
    </tr>
