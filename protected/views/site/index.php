...
<tr>
    ...
    <td style="color:grey;padding-bottom: 3%;">Разграничение прав доступа на основе системы доступа на основе ролей
        ...
        (удален пункт выбора модельера из выпадающего списка). Редактировать и удалять можно только свои заказы и
        модели. Администратору, как и положено - любые. Кроме того, администратор имеет возможность повысить до
        администратора любого другого пользователя, ровно как и понизить до модельера. Кэширование сессии пользователя.
        Покрытие приложения логами. К моделями добавлен атрибут автор. Ресайз загружаемых изображений моделей.
        На странице со всеми моделями теперь отображаются их уменьшенные изображения. Комментарии к заявкам и моделям
        больше неограничены по длине. Для удобства их написания подключен виджет
        <a href="http://ckeditor.com/">ckeditor</a>, позволяющий форматировать текст. Серьезно изменена визуальная
        основа сайта: внешний вид базируется на расширении для Yii
        <a href="http://yiibooster.clevertech.biz/">YiiBooster</a>, основанный на
        ...
        Переименовать Employee в Users. В раздел статистики добавлены 3 графика, аналогичные существующим,
        но по моделям. <p class="release_date">(xx.12.2014)</p>
    </td>
</tr>
-->
...
<tr>
    ...
    <td style="color:grey;padding-bottom: 3%;">Yii обновлен до версии 1.1.15. Каких-либо визуальных изменений
        ...
        000.
        <p class="release_date">(xx.11.2014)</p>
    </td>
</tr>
