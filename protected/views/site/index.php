...
<tr>
    ...
    <td style="color:grey">Yii обновлен до версии 1.1.16. В раздел статистики добавлены 3 графика, аналогичные
        существующим, но по моделям. <p class="release_date">(xx.xx.2015)</p>
    </td>
</tr>
-->
