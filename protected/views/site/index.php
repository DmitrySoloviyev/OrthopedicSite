...
<table style="line-height:1.6; padding:0 2% 1% 1%; text-align: justify;">
	...
	<!-- <tr><td style="vertical-align:text-top"><i>0.3</i></td><td>Новый виток развития. Каких-либо визуальных изменений практически нет,
		нового функционала не добавилось, все изменения и доработки "под капотом" сайта. Текущая ветка имеет чисто технический характер.
		В первую очередь уделено внимание безопасности сайта, его стабильности и оптимизации, с целью повышения производительности.
		Проведена адаптация сайта под высокие нагрузки при помощи повсеместного кэширования данных, при помощи <a href="http://redis.io/">
		<i>Redis</i></a>. Проанализированы и оптимизированы все MySQL-запросы при помощи лога медленных запросов, добавлены недостающие индексы к
		таблицам. Более тесная и полная интеграция с фреймворком Yii. Подключены php-акселлераторы. Полная переработка и оптимизация кода.</td></tr> -->

	<!-- <tr><td style="vertical-align:text-top"><i>0.2.4 ?</i></td><td>Добавлена возможность заносить свои материалы (в разделе
		администрирования). Просматривать модели, удалять и редактировать их. Синхронизация базы данных с мобильным приложением.</td></tr> -->
