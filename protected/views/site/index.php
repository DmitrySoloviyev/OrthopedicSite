...
<table style="line-height:1.6; padding:0 2% 1% 1%; text-align: justify;">
    ...
    <tr>
        ...
        <td style="padding-bottom: 1%;">
            ...
            <i>Продожена работа по повышению безопасности</i>: Разграничение прав доступа на основе системы доступа на
            ...
            <i>Остальное:</i> В раздел статистики добавлены 3 графика, аналогичные существующим, но по моделям. Ресайз
            загружаемых изображений моделей. На странице со всеми моделями теперь отображаются их уменьшенные
            изображения. Кэширование сессии пользователя. Покрытие приложения логами. Все логи отображаются в админке.
            Если при создании нового заказа, модель не находится, выводится сообщение с предложением ее создать. На
            странице просмотра модели можно посмотреть заказы, в которых она используется. Повышена безопасность сайта.
            <p class="release_date">(xx.xx.2015)</p>
        </td>
    </tr>
    -->
