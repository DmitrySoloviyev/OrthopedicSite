...
<tr>
    ...
    <td style="color:grey;padding-bottom: 3%;">Разграничение прав доступа на основе системы доступа на основе ролей
        ...
        Покрытие приложения логами. К моделями добавлен атрибут автор. Серьезно изменена визуальная основа сайта:
        внешний вид базируется на расширении для Yii <a href="http://yiibooster.clevertech.biz/">YiiBooster</a>,
        основанный на <a href="http://getbootstrap.com/">Bootstrap</a>, совместно с
