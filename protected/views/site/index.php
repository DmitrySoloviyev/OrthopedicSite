...
<tr>
    ...
    <td style="padding-bottom: 3%;">
        ...
        Благодаря внедрению поисковой системы полнотекстового поиска <a href="http://sphinxsearch.com/">Sphinx</a> поиск
        информации по базе данных, генерация отчета, построение графиков статистики осуществляется на порядок быстрее.
...
<tr>
    ...
    Разграничение прав доступа на основе системы доступа на основе ролей
    ...
    Покрытие приложения логами. Все логи отображаются в админке. Если при создании нового заказа, модель не находится,
    выводится сообщение с предложением ее создать. Повышена безопасность сайта. Комментарии к заказам и моделям и поле
    описание у моделей теперь являются полнотекстовыми и больше не ограниченными по длине. Добавлен специальный виджет
    для форматирования текста комментариев.
    <p class="release_date">(xx.xx.2015)</p>
    </td>
</tr>
-->
...
<tr>
    ...
    <td style="padding-bottom: 3%;">Yii обновлен до версии
        <a href="http://www.yiiframework.com/news/83/yii-1-1-16-is-released/" target="_blank">1.1.16</a>.
        Возможен множественный выбор материалов в заказе.
        Для использования сайта теперь необходимо обязательно авторизоваться: ввести логин и пароль (выдается
        администратором после создания пользолвателя в админке). Использован компонент WebUser.
        Заказы и модели добавляются от имени того пользователя, под
        ...
        визуальная основа сайта: внешний вид базируется на
        <a target="_blank" href="http://www.getyiistrap.com/">Yiistrap (Twitter Bootstrap for Yii)</a>, основанный на
        <a target="_blank" href="http://getbootstrap.com/">Bootstrap</a> с применением различных виджетов
...
<tr>
    ...
    <td style="padding-bottom: 3%;">Yii обновлен до версии
        <a href="http://www.yiiframework.com/news/78/yii-1-1-15-is-released-security-fix/" target="_blank">1.1.15</a>.
        ...
        <ul class="newsList">
            <li>
                Внедрено кэширования данных (реализовано при помощи <a target="_blank" href="http://redis.io/">Redis</a>).
                Задействовано расширение
...
<tr>
    ...
    <td>Добавлена возможность сохранять заказы
        в Excel за выбранный промежуток времени (реализована с помощью <a target="_blank"
