...
<ul>
    ...
    <del>
        <li>Php-акселлератор php-apc</li>
    </del>
    <del>
        <li>Удалять и редактировать заказы только от имени администратора.</li>
    </del>
</ul>
...
<!--    <tr>
        ...
        <td style="color:grey;padding-bottom: 1%;">
            ...
            <a href="http://sphinxsearch.com/">Sphinx</a>. AngularJS.
        </td>
    </tr>-->
    ...
    <td style="color:grey;padding-bottom: 2%;">Новая ступень развития. Каких-либо визуальных изменений практически нет,
        ...
        <ul class="newsList">
            ...
            <li>
                ...
                добавлены недостающие индексы к таблицам и т.д.
            </li>
            <li>
                ...
                <a href="http://phpunit.de/">PHPUnit</a> соответственно. Покрытие приложения тестами - 100%
                (<a href="#" id="testsReport">отчет</a>).
            </li>
            <li>
            ...
            <li>
                Блочная верстка страниц. Новое окно с регистрацией и просмотром модельеров на главной странице, предпросмотр
                загружаемого изображения модели, небольшая корректировка стилей. Удалять и редактировать заказы можно,
                только если выполнен вход от имени администратора.
            </li>
            <li>
