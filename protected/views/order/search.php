...
<!--            <div class="row">-->
<!--                --><?php
//                echo $form->TextField($model, 'OrderID', ['autocomplete' => 'Off']);
...
<!--                        <td colspan="2">-->
<!--                                <span id="pic">-->
<!--                                    <img id='Models_ModelPicture' src="--><?//= $modelsModel->ModelPicture ?><!--"-->
<!--                                         alt='изображение модели' width="200" height="200" />-->
<!--                                </span>-->
<!--                        </td>-->
<!--                    </tr>-->
<!--                    <tr>-->
<!--                        <td style="width: 1px;">Описание:</td>-->
<!--                        <td id='Models_ModelDescription'>--><?//= CHtml::encode($modelsModel->ModelDescription); ?><!--</td>-->
<!--                    </tr>-->
<!--                    <tr>-->
<!--                        <td colspan="2" id='Models_DateModified'>Дата-->
<!--                            изменения: --><?//= CHtml::encode($modelsModel->DateModified); ?><!--</td>-->
<!--                    </tr>-->
<!--                </table>-->
<!--            </fieldset>-->
<!--        </td>-->
...
<!--            <div class="row">-->
<!--                --><?php
//                echo $form->TextField($model, 'Size', ['autocomplete' => 'Off']);
...
<!--            <div class="row">-->
<!--                --><?php
//                echo $form->TextField($model, 'Urk', ['autocomplete' => 'Off']);
...
<!--            <div class="row">-->
<!--                --><?php
//                echo $form->TextField($model, 'Height', ['autocomplete' => 'Off']);
...
<!--            <div class="row">-->
<!--                --><?php
//                echo $form->TextField($model, 'TopVolume', ['autocomplete' => 'Off']);
...
<!--            <div class="row">-->
<!--                --><?php
//                echo $form->TextField($model, 'AnkleVolume', ['autocomplete' => 'Off']);
...
<!--            <div class="row">-->
<!--                --><?php
//                echo $form->TextField($model, 'KvVolume', ['autocomplete' => 'Off']);
...
<!--            <div class="row">-->
<!--                --><?php
//                echo $form->TextField($customersModel, 'CustomerSN', ['autocomplete' => 'Off', 'placeholder' => 'Фамилия']);
//                echo $form->error($customersModel, 'CustomerSN');?>
<!--            </div>-->
<!--            <div class="row">-->
<!--                --><?php
//                echo $form->TextField($customersModel, 'CustomerFN', ['autocomplete' => 'Off', 'placeholder' => 'Имя']);
//                echo $form->error($customersModel, 'CustomerFN');?>
<!--            </div>-->
<!--            <div class="row">-->
<!--                --><?php
//                echo $form->TextField($customersModel, 'CustomerP', ['autocomplete' => 'Off', 'placeholder' => 'Отчество']);
...
<!--        <td>--><?//= $form->TextArea($model, 'Comment', ['rows' => '4', 'cols' => '22']); ?><!--</td>-->
<!--    </tr>-->
<!--    <tr>-->
<!--        <td>Период:</td>-->
<!--        <td>-->
...
<!--                --><?//= CHtml::submitButton('Искать', ['class' => 'button']); ?>
<!--            </div>-->
<!--        </td>-->
<!--    </tr>-->
<!--    </table>-->
...
<!--            <tr>-->
<!--                <th>--><?//= $sort->link('OrderID', '№ заказа', ['class' => 'sorter_link']); ?><!--</th>-->
<!--                <th>--><?//= $sort->link('ModelName', 'Модель', ['class' => 'sorter_link']); ?><!--</th>-->
<!--                <th>Размер</th>-->
<!--                <th>Длина УРК</th>-->
<!--                <th>--><?//= $sort->link('MaterialID', 'Материал', ['class' => 'sorter_link']); ?><!--</th>-->
<!--                <th>Высота</th>-->
<!--                <th>Объем верха</th>-->
<!--                <th>Объем лодыжки</th>-->
<!--                <th>Объем КВ</th>-->
<!--                <th>Заказчик</th>-->
<!--                <th>--><?//= $sort->link('EmployeeID', 'Модельер', ['class' => 'sorter_link']); ?><!--</th>-->
<!--                <th>--><?//= $sort->link('Date', 'Дата заказа', ['class' => 'sorter_link']); ?><!--</th>-->
